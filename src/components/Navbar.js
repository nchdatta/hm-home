...
const arrowDown = <svg class="inline w-5 h-5 ml-1" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>;
    ...
    return (
        <nav>
            <div class="w-full lg:w-[85%] mx-auto flex flex-wrap items-center justify-between px-2 lg:px-0 py-[18px]">
                ...
                <div class={`${isNavExpanded ? 'flex' : 'hidden'} items-center justify-between w-full lg:flex lg:w-auto pt-8 pb-4 lg:pt-0 lg:pb-0`}>
                    <ul class="flex flex-col gap-3 lg:gap-7 lg:flex-row ">
