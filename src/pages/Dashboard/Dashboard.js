...
const Dashboard = () => {
    ...
    return (
        <div className='w-full min-h-screen px-4 lg:px-28 my-10'>
            <div className="flex flex-col lg:flex-row gap-5">
                <div className='p-5 w-full lg:w-1/5 bg-gray-50 flex flex-row lg:flex-col flex-wrap items-start gap-4 min-h-screen'>
                ...
                <div className='p-5 w-full bg-yellow-100'>
                    <Routes>
